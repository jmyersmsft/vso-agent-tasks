        ...
        while ($true) {
            ...
            try {
                ...
                if (Test-Path -LiteralPath $semaphoreFile -PathType Leaf) {
                    ...
                    # Warn, sleep, continue.
                    Write-Warning (Get-LocalizedString -Key "Semaphore file {0} already exists.  Retrying symbol publishing in {1} seconds..." -ArgumentList $semaphoreFile, $sleepInterval.TotalSeconds)
                ...
                Write-Warning (Get-LocalizedString -Key "{0} Accessing semaphore file: {1}, Retrying symbol publishing in {2} seconds..." -ArgumentList $_.Exception.Message, $semaphoreFile, $sleepInterval.TotalSeconds)
            }
